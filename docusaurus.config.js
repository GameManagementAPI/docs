...
const config = {
  title: 'GameManagementAPI',
  tagline: 'A powerful and flexible game infrastructure library for Minecraft plugin developers.',
  favicon: 'img/favicon.ico',


  url: 'https://gamemanagementapi.github.io/docs/',
  baseUrl: '/docs/',
  projectName: 'docs',
